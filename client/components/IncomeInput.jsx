            ...
            <Form.Row className='m-0 p-2'>
              ...
              <Col>
                <OverlayTrigger data-trigger="hover focus" placement="bottom"
                  ...
                  <FormControl name='description' className="incomeDescription" value={this.state.description} onChange={(evt) => this.changeHandler(evt)} size='sm' aria-label="Description" placeholder='Description' />
                </OverlayTrigger>
              </Col>
              <Col>
                <OverlayTrigger data-trigger="hover focus" placement="bottom"
                  ...
                  <FormControl name='amount' className="amountDescription" value={this.state.amount} onChange={(evt) => this.changeHandler(evt)} size='sm' aria-label="Amount" placeholder='$' />
                </OverlayTrigger>
              </Col>
              <Col>
                <OverlayTrigger data-trigger="hover focus" placement="bottom"
                  ...
                  <FormControl name='category' className="categoryDescription" value={this.state.category} onChange={(evt) => this.changeHandler(evt)} size='sm' aria-label="Category" placeholder='Category' />
                </OverlayTrigger>
              </Col>
              <Col>
                <OverlayTrigger data-trigger="hover focus" placement="bottom"
                  ...
                  <Form.Control name='frequency' id="frequencyDescription" value={this.state.frequency} onChange={(evt) => this.changeHandler(evt)} size='sm' as="select">
